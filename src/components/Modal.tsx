...
const ModalComponent = ({
  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full h-full bg-og-black opacity-85" />
      <div className="freezeScrollAllSizes fixed left-0 top-0 w-full h-full bg-red flex flex-row justify-center items-center">
